...
macronutrients_list <- list(
  ...
  bmi_interaction_lmm = 
    model.tables(model2.bmi.lmm.m12.lmm),
  WHR_main_lmm = 
    model.tables(model1.WHR.lmm),
  WHR_interaction_lmm = 
    model.tables(model2.WHR.lmm.m12.lmm),
  weight_main_lmm = 
    model.tables(model1.weight.lmm),
  weight_interaction_lmm = 
    model.tables(model2.weight.lmm.m12.lmm)
